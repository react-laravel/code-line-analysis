...
const api: Api = {
  ...
  stats: {
    ...
    apiRoutes: (folderId) => ipcRenderer.invoke('stats:apiRoutes', folderId),
    fileRelations: (folderId) => ipcRenderer.invoke('stats:fileRelations', folderId),
    laravelSchema: (folderId) => ipcRenderer.invoke('stats:laravelSchema', folderId),
