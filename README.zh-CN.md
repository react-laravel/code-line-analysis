...
- 支持先配置全局白名单/黑名单，再按工作区补充规则控制扫描范围。
- 界面支持英文和简体中文切换。

## 内置视图

- Workspace：添加文件夹并切换当前分析项目。
- Dashboard：查看汇总卡片和语言分布图。
...
2. 添加后应用可以立即触发首次扫描。
3. 如需应用到所有工作区，可在设置中配置全局白名单和黑名单。
4. 如需针对单个工作区补充规则，可在 Folder Manager 中继续配置。
5. 通过 Tree、Files、Tags、Top、Heatmap、Duplicates 等页面浏览结果。
6. 打开任意文件后，可查看指标、Git 信息、标签跳转，并在编辑模式下保存修改。
